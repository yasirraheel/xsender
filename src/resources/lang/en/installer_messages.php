...
return [
     ...
     */
    'welcome' => [
        'templateTitle' => 'Welcome To XSender Application',
        'title'   => 'Application Installer',
     ...
     */
    'installed' => [
        'success_log_message' => 'QXBwbGljYXRpb24gSW5zdGFsbGVyIHN1Y2Nlc3NmdWxseSBJTlNUQUxMRUQgb24g ',
    ],
    ...
    'final' => [
        ...
        'env' => 'Final .env File:',
        'user_portal' => 'Click here to User Panel',
        'admin_portal' => 'Click here to Admin Panel',
        'admin_access' => "<big>".' Admin Credential To Login '."<br>".' Username: admin | Password: admin '."<br><font color='red'>".' Please change default credential for your security purpose '."</font></big>",
    ...
    'updater' => [
        ...
        'log' => [
            'success_message' => 'QXBwbGljYXRpb24gSW5zdGFsbGVyIHN1Y2Nlc3NmdWxseSBVUERBVEVEIG9u ',
        ],
    ],
];
