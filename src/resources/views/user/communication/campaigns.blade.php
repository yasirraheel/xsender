                    ...
                    <tbody>
                        @forelse($logs as $campaign)
                            ...
                            <tr>
                                ...
                                <td>{{ $campaign->name }}
                                    <span data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="{{ translate("Created By: ") }}{{ $campaign->user_id ? $campaign->user?->name : translate('user')}}">
                                        <i class="ri-question-line"></i>
                                    </span>
                                </td>
                                <td data-label="{{ translate('Message Logs')}}">
                                    <a href="{{route("user.communication.{$campaign->type->value}.index", ['campaign_id' => $campaign->id])}}" class="badge badge--primary p-2">
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-1">
                                        <a class="icon-btn btn-ghost btn-sm success-soft circle" href="{{ route("user.communication.{$campaign->type->value}.campaign.edit", ['id' => $campaign->id]) }}">
                                        ...
                                        <button class="icon-btn btn-ghost btn-sm danger-soft circle text-danger delete-campaign"
                                                ...
                                                data-url = "{{route('user.communication.sms.campaign.destroy',['id' => $campaign->id])}}"
