<div class="installer-progress neon-progress">
    <ul class="progress-list">
        <li @if(request()->routeIs('install.init')) class="active" @endif >
            <div>
                <div class="icon neon-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink"  x="0" y="0" viewBox="0 0 512 512" xml:space="preserve" ><g><circle cx="377" cy="377" r="120"  fill="none"  stroke-width="30" stroke-miterlimit="10" data-original="#000000"></circle><path d="M377 302v30M377 437v-60h-30M347 437h60M75 61v30M15 15h422v122H15zM75 182v30M437 137v136.054M15 257V137M75 302v30M135 61v30M135 182v30M135 302v30M257.002 377H15V257h422"  fill="none"  stroke-width="30" stroke-miterlimit="10" data-original="#000000"></path></g></svg>
                </div>
                <div class="content">
                    <h6 class="step-title">{{trans("default.init_title")}}</h6>
        ...
        <li @if(request()->routeIs('install.requirement.verification')) class="active" @endif >
            <div>
                ...
                <div class="content">
                    <h6 class="step-title">{{trans("default.requirments_title")}}</h6>
        ...
        <li @if(request()->routeIs('install.envato.verification')) class="active" @endif>
            <a href="javascript:void(0)">
                ...
                <div class="content">
                    <h6 class="step-title">{{trans("default.envato_verification_title")}}</h6>
