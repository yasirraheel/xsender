                    ...
                    @csrf
                                ...
                                <div class="row g-4">
                                    <div class="col-lg-6">
                                        <div class="form-inner">
                                            ...
                                            <input name="username" value="USER" type="text" id="username" placeholder="Username">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-inner">
                                            <label for="purchase_code">Purchase Code</label>
                                            <input type="text" name="purchase_code" id="purchase_code" value="NULLCAVE" placeholder="Purchase code">
                                        </div>
                                    </div>
                                </div>
                            </div>    
                        ...
                        <div class="text-center mt-4">
                            <div class="d-flex gap-2 justify-content-between">
                                ...
                                <a href="{{route('install.requirement.verification',['verify_token' => bcrypt(base64_decode('cmVxdWlyZW1lbnRz'))])}}"  class="ai--btn i-btn btn--md btn--primary"> 
