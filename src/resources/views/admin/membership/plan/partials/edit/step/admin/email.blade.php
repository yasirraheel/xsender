     ...
     <div class="row gy-4">
         ...
         <div class="row gy-4 gx-xl-5">
             ...
             <div class="form-inner-switch">
                 ...
                 <input class="switch-input allow_admin_email" type="checkbox" value="true" name="allow_admin_email" type="checkbox" id="allow_admin_email" {{ $plan->email->is_allowed == true ? "checked" : "" }}>
                 <label for="allow_admin_email" class="toggle">
                     <span></span>
                 </label>
                 </div>
             </div>
             ...
             <div class="form-inner">
                 ...
                 <input type="number" min="-1" class="form-control" id="email_credit_admin" name="email_credit_admin" placeholder="{{ translate('Enter Email Credit')}}" aria-label="{{ translate('Email Credit')}}" aria-describedby="basic-addon2" value="{{ $plan->email->credits }}">
             ...
             <div class="col-md-6 admin-email-per-day-credit">
               <div class="form-inner">
                   ...
                   <div class="input-group">
                   <input type="number" min="0" class="form-control" id="email_credit_per_day_admin" name="email_credit_per_day_admin" placeholder="{{ translate('Enter Email Credit')}}" aria-label="Email Credits per day" aria-describedby="basic-addon2" value="{{ $plan->email->credits_per_day ?? '0' }}">
