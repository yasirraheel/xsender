                                ...
                                <div class="row gy-4">
                                    <div class="col-md-6">
                                        <div class="form-inner">
                                            ...
                                            <input type="text" id="title" name="title" class="form-control" placeholder="{{ translate("Enter blog title") }}" aria-label="blog title" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-inner">
                                ...
                                <div class="row gy-4">
                                    <div class="col-12">
                                        <div class="form-inner">
                                            ...
                                            <textarea class="form-control" name="description" id="description" rows="12" placeholder="{{ translate('Enter blog description') }}" aria-label="{{ translate('blog description') }}"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
