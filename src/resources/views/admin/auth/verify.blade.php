    ...
    <div class="container-fluid px-0">
        ...
        <div class="col-lg-6">
            ...
            <div class="auth-form-wrapper">
                <form action="{{route('admin.email.password.verify.code')}}" method="POST" class="auth-form">
                    @csrf
                <h3 class="mb-4">{{ translate("Account Verification Code") }}</h3>
                <div class="form-inner mb-4">
                    ...
                    <input type="text" id="code" name="code" class="form-control" placeholder="Enter your code" aria-label="code" />
                    </div>
                </div>
