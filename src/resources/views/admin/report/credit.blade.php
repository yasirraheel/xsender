        ...
        <div class="container-fluid px-0 main-content">
                    ...
                    <div class="row g-3">
                        <div class="col-lg-4">
                            <div class="filter-search">
                                <input type="search" value="{{request()->search}}" name="search" class="form-control" id="filter-search" placeholder="{{ translate("Filter by User name or email") }}" />
            ...
            <div class="card">
                ...
                <div class="card-body px-0 pt-0">
                    ...
                    @include('admin.partials.pagination', ['paginator' => $creditLogs])
                </div>
            </div>
        </div>
    </main>
