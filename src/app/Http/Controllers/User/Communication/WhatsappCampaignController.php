...
class WhatsappCampaignController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return $this->dispatchService->loadCampaignLogs(channel: ChannelTypeEnum::WHATSAPP, user: $user);
    }
    ...
    public function create(): View
    {
        $user = auth()->user();
        Session::put("menu_active", true);
        return $this->dispatchService->createCampaignLog(channel: ChannelTypeEnum::WHATSAPP, user: $user);
    }
    ...
    public function store(SmsCampaignRequest $request): RedirectResponse
    {
        try {
            $user = auth()->user();
            Session::put("menu_active", true);
            return $this->dispatchService->storeDispatchLogs(type: ChannelTypeEnum::WHATSAPP, request: $request, isCampaign: true, user: $user);
    ...
    public function edit($id): View
    {
        $user = auth()->user();
        Session::put("menu_active", true);
        return $this->dispatchService->showCampaignLog(channel: ChannelTypeEnum::WHATSAPP, id: $id, user: $user);
    }
    ...
    public function update(SmsCampaignRequest $request, $id): RedirectResponse
    {
        try {
            $user = auth()->user();
            Session::put("menu_active", true);
            return $this->dispatchService->storeDispatchLogs(type: ChannelTypeEnum::WHATSAPP, request: $request, isCampaign: true, campaignId: $id, user: $user);
